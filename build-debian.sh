...
buildah config --label "org.opencontainers.image.title=OpenCode Server (Debian)" "${CTR}"
buildah config --label "org.opencontainers.image.description=Hardened OpenCode server container image (Debian)" "${CTR}"
